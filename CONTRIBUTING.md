...
| `src/range.js` | Parses page ranges like `1-3, 5, 8-` for Extract |
...
| `scripts/copy-assets.mjs` | Copies pdf.js fonts, the DejaVu fonts for Unicode text, and the OCR engine and data into `public/` so nothing loads from a CDN |
